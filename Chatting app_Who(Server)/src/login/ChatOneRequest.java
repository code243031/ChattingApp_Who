...
public class ChatOneRequest extends Request{
	
	
	public ChatOneRequest() {
	...
	public void run() {
		...
		System.out.println("Waiting for connect chatting 1 to 1...");
		try {
			...
			recieve.bind(new InetSocketAddress("localhost", 4100));
